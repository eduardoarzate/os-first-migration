...
<%
	...
	System.out.println("URI: "+request.getRequestURI()+"\n URL_LOCAL: "+request.getScheme()+"://"+request.getLocalName()+":"+request.getLocalPort() );
...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">			
			...
			{
			%>
			//Marca de cambio Jose Andres Castillo Moreno 27/04/2009
			var soapURL = "<%=(String)request.getAttribute("SoapURL")%>";
			if(document.location.toString().lastIndexOf("http://")>0||document.location.toString().lastIndexOf("https://")>0){
				soapURL="/"+soapURL;
