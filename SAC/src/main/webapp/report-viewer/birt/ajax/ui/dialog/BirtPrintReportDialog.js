	...
	__printAction : function( )
	{
		...
		{	
			...
			*/
			...
			// o3 retrieve previous window instance resizable
			var previousPrintWindow = window.open( '', Constants.WINDOW_PRINT_PREVIEW, 'location=no,scrollbars=yes,dependent=yes,resizable=yes' );
			try
			{
