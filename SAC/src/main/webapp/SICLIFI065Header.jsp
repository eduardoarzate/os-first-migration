<%
/*###############################################################################
# Nombre del Programa :  SICLIFI065Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICLIFI065Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIFI065 - Consulta de Saldos por Grupos. Informativa Pesos-D&oacute;lares</font></th>
                </tr>
				<tr>
					<td>&nbsp;</td>
					<td colspan="4"><br/></td>
