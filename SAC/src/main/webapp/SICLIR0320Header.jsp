<%
/*###############################################################################
# Nombre del Programa :  SICLIR0320Header.jsp                                   #
...
# Compania            : WELLCOM                                                 #
# Proyecto/Procliente : P-06-2233-13                Fecha:  17-03-2015          #
# Modificación        :                                                         #
#-----------------------------------------------------------------------------  #
...
<%@page import="com.wellcom.prosa.sacii.ComboBox"%><jsp:useBean id="ga" scope="session" class="com.wellcom.prosa.sacii.GrantAccess"/>
...
<%
   ...
   // Inicia cambio WELLCOM P-06-2233-13 17-03-2105
   ArrayList cbTipoLiq= comboBox.getTipoLiqCorresponsal(session);
   // Fin cambio WELLCOM P-06-2233-13 17-03-2105
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0320Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0320 - Reporte Consolidado de Saldos</font></th>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Tipo Liquidaci&oacute;n:</strong></td>
                        <td align="left">
                            <%
                                    HTML cb = new HTML();
                                    out.println( "" + cb.getListBox( "tipoLiq", cbTipoLiq, "Selecciona un Tipo Liq." ) );
                            %><br/>
