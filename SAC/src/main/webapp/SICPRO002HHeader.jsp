...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletPromoH?action=SICPRO002HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICPRO002 - Reporte de Transacciones con Promoci&oacute;n</font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getListBox( "bancoSocio", cbBancosSocios, "Selecciona un Banco" ) );
                        ...
                        <td align="left"><strong>Proceso</strong><strong>:</strong> </td>
                        <td align="left">
                            <%
            comboBox = new HTML();
