...
<%
    ...
    cbBancos = myComboBox.getDrawDown(session);
    cbTipo = myComboBox.getTipo(session);
%>
...
<html>
    ...
    <!--Marca de cambio:  SAS-DRT F-52-8063-16  inicio Modificación -->
            <form action="ControllerServletMasVi?action=SICVSA0050Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
    <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICVSA0050 - Reporte de Transacciones VISA<br></font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getListBox( "banco", cbBancos, "Selecciona un Banco" ) );
                            %><br/>
                            <span id = "txtBancoSocio" class="ocultar">Elije una Opción</span>
                        </td>
                        <td align="left"><strong>Tipo de Reporte:</strong> </td>
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "Tipo", cbTipo, "Selecciona un Tipo" ) );
                            %><br/>
