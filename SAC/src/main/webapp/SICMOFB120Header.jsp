<%
/*###############################################################################
# Nombre del Programa :  SICMOFB120Header.jsp                                   #
...
<html>
            ...
            function valida(form1, accion)
            {
                    ...
                    try
                    {
                        ...
                        } else
                        {
                            sendMoreDatas('mes', 'year', 'bancoAdq', 'bancoEmi', 'NoTrans', 'Fuente', 'importe',
                                    'NoCuenta', 'NoAuto', 'NoRef', 'NoComer', 'NomComer', 'GiroComer', 'tablePaintB120', 'tableResult', '0');
                ...
                if (accion == 1 || accion == 2) {
                    sendMoreDatas('mes', 'year', 'txtfStartDate', 'bancoAdq', 'bancoEmi', 'NoTrans', 'Fuente', 'importe',
                            'NoCuenta', 'NoAuto', 'NoRef', 'NoComer', 'NomComer', 'GiroComer', 'tablePaintB120', 'tableResult', accion);
                    ventana(window.open('please.jsp', '', 'left=250,top=300,width=600,height=100,directories=0,location=0,menubar=0,resizable=1,scrollbars=1,status=0,titlebar=0,toolbar=0'));
                    return true;
                }
            }
    ...
    <body>
        ...
        <div align="center">
            ...
            <form action="ControllerServletAdquirente?action=SICMOFB120Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" colspan=5 align="left" ><font color="#000000">SICMOFB120 - Consulta de Transacciones Rechazadas</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <% 
                     String bandera=(String)session.getAttribute("mostrarTabla");
                      ...
                      //String table= (String)session.getAttribute("tabla0100" );
                              ...
                              out.println(tab.createTable(121));
