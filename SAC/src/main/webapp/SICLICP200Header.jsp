...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLICP200Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left"><font color="#000000">SICLICP200 - Reporte Corresponsales Detalle PROSA</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%comboBox = new HTML();
                           out.println(""	+ comboBox.getListBox("bancoEmi", cbEmisor,	"Selecciona un Banco"));%><br />
                            <span id="spamEmisor" class="ocultar">Elija una Opción</span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Naturaleza Contable:<br>
                            </strong></td>
                        <td align="left">
                            <%comboBox = new HTML();
                        out.println("" + comboBox.getComboBox("natCon", cbNatCon,	"Seleccione una opcion"));%> 
                            <span id="spamNaturaleza" class="ocultar">Elija	una Opción</span></td>
                        <td align="left"><strong>Banco Adquirente:<br></strong>
                        </td>
                        <td align="left">
                            <%comboBox = new HTML();
                        out.println("" + comboBox.getComboBox("bancoAdq",cbAdquirente,"onchange","javascript:sendDatas('bancoAdq','txtfStartDate','corresponsal','comboBoxArchivo');","Seleciona Un Banco"));%><br />
