<%
/*###############################################################################
# Nombre del Programa :  SICLIRB150Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
...
<%
    ...
    cbBancoEmiValues = myComboBox.getBancoAdqDol(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletAdquirente?action=SICLIRB150Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRB150 - Reporte Liquidaci&oacute;n Nacional / Internacional D&oacute;lares<br></font></th>
                    </tr>
