<%
/*###############################################################################
# Nombre del Programa :  SICLIR0110OPAMHeader.jsp                               #
# Autor               :  JOAQUIN MOJICA Q.                                      #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  Z-09-2573-12                	   FECHA:20/11/2012     #
# Descripcion General :										                    #
#                                                                               #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0110OPAMMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0110 OPAM - Compensacion de Interredes de Bancos Socios</font>  
                        </th>
                    </tr>
