<%
/*###############################################################################
# Nombre del Programa :  SICDCC0100Header.jsp                                   #
...
# Autor               :  Gerardo G. Burguete.                                   #
# Compania            :  Axia Consultores, S.A. de C.V.                         #
# Proyecto/Procliente :  P-02-0060-12                Fecha: 29/07/2014          #
...
<%
    ...
    cbBancos = myComboBox.getDrawDownDccPMTU(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletReDCC?action=SICDCC0100Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICDCC0100 Transacciones Aceptadas DCC por Comercio</font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input name="txtfEndDate" type="text" id="txtfEndDate" size="15"  maxlength="15" value=<%=session.getAttribute("fechaHoy")%>>
                            <a href="javascript:void(0)" onclick="if (self.gfPop)
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <br>
                            <% comboBox = new HTML();out.println( "" + comboBox.getListBox( "banco", cbBancos, "Selecciona un Banco" ) );%>
                            <br/><span id = "txtBancoSocio" class="ocultar">Elije una Opción</span>
                        </td>
                        <td>
                            <%
                            /*------------------------------------------------------------------------------*/
                            /* Marca del Cambio : Axia-GGB-P-02-0060-12 Inicia  la Modificacion 29/07/2014--*/
                            /*------------------------------------------------------------------------------*/
                            %>  				          	
                            <br><strong>Fuente:&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                            <select id="fuente" name="fuente">
                                <option selected value=  "5">PTLF</option>>
                                <option          value="190">TEF DCC</option>>
                            </select>
                            <br/>
                            <%
                            /*------------------------------------------------------------------------------*/
                            /* Marca del Cambio : Axia-GGB-P-02-0060-12 Termina la Modificacion 29/07/2014--*/
                            /*------------------------------------------------------------------------------*/
                            %>                                                    
                        </td>
                        <td>
                            <br><strong>Tipo Trx:&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                            <select id="ttr" name="ttr">
                                <option selected value="1">Ventas</option>
                                <option value="21">Devoluciones</option>
                                <option value="9">Representaciones</option>
                                <option value="15">Contracargos</option>
                            </select>
                            <br/>
                        </td>
                        <td>&nbsp;</td>
