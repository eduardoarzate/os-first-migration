<%
/*###############################################################################
# Nombre del Programa :  SICCOMR001Header.jsp		                   			#
...
<html>
    ...
    <body>
        <div align="center">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  inicio ModificaciÛn -->
            <form action="ControllerServletHub?action=SICCOMR001Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin ModificaciÛn -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICCOMR001 - Reporte de Comisiones<br></font></th>
                    </tr>
