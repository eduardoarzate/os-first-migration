<%
/*###############################################################################
# Nombre del Programa :  SICMIRD121Header.jsp                                   #
...
<%
    ...
    //cbBancosSocios = myComboBox.getBancoSacD065(session);
    cbBancosSocios = myComboBox.getBancoDol(session);
    cbTipoTxn = myComboBox.getTipoTrxsMisc(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletEmisorDolares?action=SICMIRD121Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIRD121 - BASE II-48 fee-collection/founds disbursement</font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getListBox( "bancoSocio", cbBancosSocios, "Selecciona un Banco" ) );
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getListBox( "tipoTxn", cbTipoTxn, "Selecciona un Tipo de Transacción" ) );
                            %><br/>
