<%
/*###############################################################################
# Nombre del Programa :  SICMIR0420Header.jsp                                   #
...
<%
   ...
   cbBancoAdqValues  = myComboBox.getBancosSinDol(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegracion?action=SICMIR0420Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR0420 - Reporte Resumen de Adquirente</font></th>
                    </tr>
