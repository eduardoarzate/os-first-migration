<%
/*###############################################################################
# Nombre del Programa :  SICLIRI140Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletInformativa?action=SICLIRI140Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRI140 - Consolidado Interredes informativa Pesos-Dolares<br></font></th>
                    </tr>
