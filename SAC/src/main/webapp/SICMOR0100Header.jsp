...
<%
        ...
        ArrayList cbTransaccValues;
        ArrayList cbArchivoFValues;
        HTML comboBox;
        HTML inputText;
...
<%
    if(!ga.AccessGranted(session, "grantAccess"))
    {
     ...
     cbTransaccValues = myComboBox.getGrupoTrxs(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextnTransac)
                {
                    span = document.getElementById('txtnTransac');
                    span.style.display = 'none';
                    showTextnTransac = false;
                ...
                } else if (document.frmTOCHeader.bancoAdq.value == "None")
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.nTransac.value == "None")
                {
                    span = document.getElementById('txtnTransac');
                    span.style.display = 'inline';
                    showTextnTransac = true;
                    return false;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMonitoreo?action=SICMOR0100Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan=5 align="left"><font color="#000000">SICMOR0100 Reporte de Transacciones Aceptadas por Comercio</font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input name="txtfStartDate" type="text" id="txtfStartDate" size="15" readonly maxlength="15" onblur="javascript:sendDatas('bancoAdq', 'txtfStartDate', 'archivoAdqFechas', 'comboBoxArchivo');" value=<%=session.getAttribute("fechaHoy")%>>
                        ...
                        <td>
                            <input name="txtfEndDate" type="text" id="txtfEndDate" size="15" readonly maxlength="15" onblur="javascript:sendDatas('bancoAdq', 'txtfStartDate', 'archivoAdqFechas', 'comboBoxArchivo');" value=<%=session.getAttribute("fechaHoy")%>>
                            <a href="javascript:void(0)" onclick="if (self.gfPop)
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
                            comboBox = new HTML();
                            out.println( "" + comboBox.getComboBox( "bancoAdq", cbBancoAdqValues, "onchange", "javascript:sendDatas('bancoAdq','txtfStartDate','archivoAdqFechas','comboBoxArchivo');","Seleciona Un Banco" ) );
                            %><br/>
                            <span id = "txtBancoAdq" class="ocultar">Elije Una Opción</span>
                        </td>
                        <td align="left"><strong>No. de Transacci&oacute;n</strong></td> 
                        <td>
                            <%
                            comboBox = new HTML();
                            out.println( "" + comboBox.getListBox( "nTransac", cbTransaccValues, "Selecciona Una Transacción" ) );
                            %><br/>
                            <span id = "txtnTransac" class="ocultar">Elije Una Opción</span>
                        </td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left"><strong>Agrupar por Comercio:</strong></td>
                        <td align="left">
                            <input type="checkbox" name="agrNatContable" title="Reporte Agrupado por Naturaleza Contable Crédito/Débito" >
                            <br/>
                        </td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Afiliacion:</strong></td>
                        <td align="left">
                            <%
                                    inputText = new HTML();
                                    out.println( "" + inputText.getinputText( "afiliacion", 23,23 ) );
                            %><br/>
                            <span id = "txtAfiliacion" class="ocultar">Ingrese una Afiliacion</span>
                        </td>                  	
                    </tr>	
                    <tr>
                        <td>&nbsp;</td>
