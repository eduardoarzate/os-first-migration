...
<%
    ...
    cbBancosSocios = myComboBox.getBancosAdqsHijos(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICMOR0180Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0180 - Reporte de Cifras de Control de Archivos de Entrada (Consolidado)</font></th>
                </tr>
