...
<%
   ...
   cbBCO = myComboBox.getBancoAdq(session);
...
<html>
        ...
        function valida()
        {
            try
            {
                ...
                if (document.frmTOCHeader.txtfStartDate.value == "" || document.frmTOCHeader.txtfStartDate.value == null)
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.adq.value == "" || document.frmTOCHeader.adq.value == 'None')
                {
                    span = document.getElementById('spambanco');
                    span.style.display = 'inline';
                    verbanco = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegracion?action=SICMIF0450Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIF0450 - Reporte Integral de Transacciones por Comercio</font><br></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
                                    inputText = new HTML();
                                    out.println( "" + inputText.getComboBox( "adq", cbBCO,"Seleccione un Banco" ) );
                            %><br/>
