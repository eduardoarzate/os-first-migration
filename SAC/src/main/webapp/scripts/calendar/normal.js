...
var gcCalBG="#EAF3FF";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#EAF3FF";	// the background color of the inner table, showing as a frame.
...
var gsOuterTable=NN4?"border=0 cellpadding=0 cellspacing=1":"border=0 cellpadding=0 cellspacing=1";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' > "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcSat="#FF7800";	// Saturday font color
var gcSatBG="#FFEBDA";	// Saturday background color
var gcSun="#FF7800";	// Sunday font color
var gcSunBG="#FFEBDA";	// Sunday background color
...
var gcToggle="#E4F5E2";	// the highlight color for the focused cell

var gcFGToday="#FFEBDA";	// the font color for today 
var gcBGToday="#FF7800";	// the background color for today 
...
var gcBGSelected="#BED6F8";	// the background color for the selected date
