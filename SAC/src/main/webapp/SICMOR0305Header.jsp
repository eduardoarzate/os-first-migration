...
<%
    ...
    cbTipoTransacValues = myComboBox.getGrupoTrxs2(session);
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMonitoreo?action=SICMOR0305Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
