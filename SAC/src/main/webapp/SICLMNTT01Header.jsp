<%
/*###############################################################################
# Nombre del Programa :  SICLMNTT01Header.jsp		    						#
...
<%
    ...
    listLiquidacion = comboBox.getLiqEGLCL(session);
%>
...
<html>
        ...
        function valida()
        {
            try
            {
                ...
                } else if (document.frmTOCHeader.cmbMarcas.value == "None")
                {
                    ...
                    showTextMarca = true;
                    return false;
                } else if (document.frmTOCHeader.cmbLiq.value == "None")
                {
                    span = document.getElementById('txtInst');
                    span.style.display = 'inline';
                    showTextInst = true;
    ...
    <body>
        <div align="center">
            ...
            <form name="frmTOCHeader" id="frmTOCHeader" target="mainFrameTOC" method="post" action="ControllerServletInterf?action=SICLMNTT01Main">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLMNTT01 - Reporte Consolidado de Cifras POS (por marca)<br></font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <% 
                                    out.println(htmlCmb.getListBox("cmbLiq", listLiquidacion, "Seleccione una Liquidaci&oacute;n"));
                            %><br/>
