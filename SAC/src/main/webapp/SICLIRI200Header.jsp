<%
/*###############################################################################
# Nombre del Programa :  SICLIRI200Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
...
<%
   ...
   cbBancoAdqValues  = myComboBox.getBancoEmiDolConsol(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        var showTextbancoAdquiriente = false;
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextbancoAdquiriente)
                {
                    span = document.getElementById('txtBancoAdquiriente');
                    span.style.display = 'none';
                ...
                } else if (document.frmTOCHeader.txtfEndDate.value == "" || document.frmTOCHeader.txtfEndDate.value == null)
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.bancoAdquiriente.value == "None")
                {
                    span = document.getElementById('txtBancoAdquiriente');
                    span.style.display = 'inline';
                    showTextbancoAdquiriente = true;
                    return false;
                } else
                {
                    return true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletInformativa?action=SICLIRI200Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRI200 - Reporte Consolidado Liquidaci&oacute;n Total. Informativa Pesos-D&oacute;lares<br></font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getListBox( "bancoAdquiriente",  cbBancoAdqValues, "Selecciona un Banco"  ) );
                            %><br/>
                            <span id = "txtBancoAdquiriente" class="ocultar">Elije una Opción</span>
                        </td>
                        <td><br/></td>
                        <td><br/></td>
                    </tr>
