<%
/*###############################################################################
# Nombre del Programa :  SICLIR0360Header.jsp                                   #
...
<%
   ...
   myComboBox = new ComboBoxGen();
         /* Modificacion: Marca de inicio    SAS-DRT F-52-8063-16  */  
   cbBancoValues  = myComboBox.getBancoAdqEmiSinEglo(session);   
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                {
                    span = document.getElementById('txtES');
                    span.style.display = 'none';
                    showES = false;
                }
                ...
                } else if (document.frmTOCHeader.tipoProc.value == "None")
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.tipoES.value == "None" && document.frmTOCHeader.tipoProc.value == "774")
                {
                    span = document.getElementById('txtES');
                    span.style.display = 'inline';
                    showES = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletLiqH?action=SICLIR0360HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0360 - Reporte de Contracargos y Representaciones</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
            ...
            out.println( "" + comboBox.getListBox( "banco",  cbBancoValues, "Selecciona un Banco"  ) );
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "tipoProc",  cbTipoProc, "onchange", "javascript:sendData('tipoProc','cargafavor','favor');", "Selecciona un Tipo de Proceso") );
                            %><br/>
                    ...
                    <tr>
                        ...
                        <td align="left" id="favor">
                            <select >
                                <option selected="selected" value="None">Selecciona una opcion</option>
                            </select>
                        </td>  						
                    </tr>
