<%
/*###############################################################################
# Nombre del Programa : SICLIR0462Header.jsp                                    #
...
try{
    ...
    /* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */
        cbBancoAdqValues = myComboBox.getBancoBuAdq(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                {
                    span = document.getElementById('bancoAdq');
                    span.style.display = 'inline';
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0462Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0462 -Transacciones Extempor&aacute;neas por Adquirente </font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
