<%
/*###############################################################################
# Nombre del Programa :  SICLIR0020Header.jsp                                   #
...
<%
    ...
    cbTipo = myComboBox.getEmiAdq3(session);    
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                {
                    span = document.getElementById('txtComercio');
                    span.style.display = 'none';
                ...
                } else if (document.frmTOCHeader.tipo.value == "None")
                {
                    ...
                    showTextTipo = true;
                    return false;
                } else if (document.frmTOCHeader.comercio.value == "")
                {
                    span = document.getElementById('txtComercio');
                    span.style.display = 'inline';
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletPromoH?action=SICPRO001HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICPRO001 - Reporte de Transacciones con&nbsp; Promoci&oacute;n por Comercio</font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getListBox( "bancoSocio", cbBancosSocios, "Selecciona un Banco" ) );
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "tipo", cbTipo, "Selecciona el tipo" ) );
                            %><br/>
       ...
       out.println( "" + inputText.getinputText("comercio",20,20));
                            %><br/>
                            <!-- <span id = "txtComercio" class="ocultar">Ingrese el Comercio</span> -->
                        </td>  						
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
