<%
/*###############################################################################
# Nombre del Programa :  SICLIR0011Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
# Proyecto/Procliente :  P-08-299-04                 	   FECHA:12/08/2013       #
# Descripcion General :                                                         #
#                                                                               #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0011Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0011 - Reporte de Compensaciones Complementarias PROSA</font></th>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Fecha Liquidacion Inicio:</strong></td>
                        <td align="left">
                        ...
                        <td align="left"><strong>Fecha Liquidacion Fin:</strong></td>
                        <td align="left">
