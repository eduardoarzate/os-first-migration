<%
/*###############################################################################
# Nombre del Programa :  SICTRC0002Header.jsp                                   #
...
<%
   ...
   cbBancoAdqInterRedValues = myComboBox.getBancoTranscod2(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
          try
          {
            ...
            {
              span = document.getElementById('txtfCtaOri2');
              span.style.display = 'none';
              showTextCtaOri = false;

            }   else if(showTexteCtaDes)
            {
              span = document.getElementById('txtfCtaDest2');
              span.style.display = 'none';
    ...
    <body>
        <div align="center">
            <form action="ControllerServletTrascod?action=SICTRC0002Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left"><font color="#000000">SICTRC0002 - Consulta de cuentas activas para trascodificar<br></font></th>
                </tr>
        ...
        <tr>
          ...
          <td colspan="4"><br/></td>
            ...
            <tr>
              ...
              <td align="left">
                <% comboBox = new HTML();
                             out.println( "" + comboBox.getListBox( "numFiid", cbBancoAdqInterRedValues, "Selecciona una FIID" ) );
                          %><br/>
            ...
            <tr>
                ...
                <td align="left"><strong>Cuenta Origen:</strong></td>
                        <td align="left">
                          <input name="txtfCtaOri2" type="text" id="txtfCtaOri2" size="20"  maxlength="20" value="" >
                     <span id = "txtfCtaOri2" class="ocultar">Escribe la cuenta origen</span>
                        </td>
                <td align="left"><strong>Cuenta Destino:</strong></td>
                        <td align="left">
                          <input name="txtfCtaDest2" type="text" id="txtfCtaDest2" size="20" maxlength="20" value="" >
                   <span id = "txtfCtaDest2" class="ocultar">Escribe la cuenta destino</span>
                        </td>
            </tr>
