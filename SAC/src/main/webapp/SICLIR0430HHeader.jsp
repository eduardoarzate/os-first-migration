<%
/*###############################################################################
# Nombre del Programa :  SICLIR0430Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletLiqH?action=SICLIR0430HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0430 - Dep&oacute;sitos por Banco e Interred</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <tr> 
                        <td>&nbsp;</td>
                        <td align="left"><strong>Interred:</strong></td>
                        <td align="left">
                            <% comboBox = new HTML();
                               out.println( "" + comboBox.getListBox( "interred", cbInterRedValues, "Selecciona una Interred" ) );
                            %><br/>
