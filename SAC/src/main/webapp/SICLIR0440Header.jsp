<%
/*###############################################################################
# Nombre del Programa :  SICLIR0440Header.jsp                                   #
...
<%
    ...
    cbEdoValues = myComboBox.getEdoCompl(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextEstado)
                {
                    span = document.getElementById('txtEstado');
                    span.style.display = 'none';
                    showTextEstado = false;
                }
                ...
                } else if (document.frmTOCHeader.txtfEndDate.value == "" || document.frmTOCHeader.txtfEndDate.value == null)
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.estado.value == "None" || document.frmTOCHeader.estado.value == null)
                {
                    span = document.getElementById('txtEstado');
                    span.style.display = 'inline';
                    showTextEstado = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletInterf?action=SICLIR0440Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0440 - Reporte de Liquidaciones Complementarias de Facturaci&oacute;n   
                            </font></th>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Entidad:</strong></td>
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getComboBox( "estado", cbEdoValues, "Selecciona un Estado" ) );
                            %><br/>
                            <span id = "txtEstado" class="ocultar">Elije una Opción</span>
                        </td>
                        <td><br/></td>
                    </tr>
