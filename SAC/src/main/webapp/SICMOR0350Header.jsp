<%
/*###############################################################################
# Nombre del Programa :  SICMOR0350Header.jsp                                   #
...
<%
   ...
   cbBancoValues  = myComboBox.getBancoBuAdq(session);
   cbTtrValues = myComboBox.getTipoTrxsVenDev(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMonitoreo?action=SICMOR0350Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0350 - Reporte de Transacciones con Reversos</font></th>
                    </tr>
                    ...
                    <tr> 
                        ...
                        <td align="left">
                            <% comboBox = new HTML();
                               out.println( "" + comboBox.getListBox( "bancoAdq", cbBancoValues, "Selecciona un Banco" ) );
                            %><br/>
                        ...
                        <td align="left">
                            <%
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getListBox( "tipoTrans", cbTtrValues, "Selecciona una Transacción" ) );
                            %><br/>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Mostrar Consolidado:</strong></td>
                        <td align="left">
                            <input type="checkbox" name="ver" title="Reporte Transacciones con Reverso" >
                            <br/>
                            <span id = "txtVer" class="ocultar">Elije una Opción</span>
                        </td>
                        <td><br/></td>
                        <td><br/></td>
                    </tr>                 
