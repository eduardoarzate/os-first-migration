<%
/*###############################################################################
# Nombre del Programa :  SICDCC0060Header.jsp                                   #
...
<%
    ...
    cbBancos = myComboBox.getDrawDownDcc(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletReDCC?action=SICDCC0060Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICDCC0060 Reporte de Transacciones DCC</font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <select id="tipo" name="tipo">
                                <option selected value="MTH">REPORTE DE TRANSACCIONES MATCH</option>>
                                <option value="PRS">REPORTE DE TRANSACCIONES SOBRANTES DE PROSA</option>>
                                <option value="MTH">REPORTE DE TRANSACCIONES SOBRANTES DE FINTRAX</option>>
                            </select>
                            <br/>
                        </td>
                        <td><br/></td>
