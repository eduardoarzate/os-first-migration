<%
/*###############################################################################
# Nombre del Programa :  SICLIR0110OPAMHHeader.jsp                              #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletLiqH?action=SICLIR0110OPAMHMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0110OPAM - Liquidación de Interredes de Bancos Socios</font>  
                        </th>
                    </tr>
