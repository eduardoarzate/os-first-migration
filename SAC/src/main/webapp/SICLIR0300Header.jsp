<%
/*###############################################################################
# Nombre del Programa :  SICLIR0300Header.jsp                                   #
...
/* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */
    cbBancoAdqValues  = myComboBox.getEntidadFuente(session);
...
<html>
    ...
    <script type="text/javascript">
        ...
        var showTextArchivoEmi = false;
        var showarchivoSalida_OK = false;
        var showarchivoEntrada_OK = false;
        var showtipoTransac = false;
        ...
        function valida() {
            ...
            try
            {
                if (document.getElementById("txtfStartDate").value == "") {
                    ...
                    span.style.display = 'inline';
                } else if (document.getElementById("bancoAdq").value == "None") {
                    banderaValidar = false;
                    span.innerHTML = "Favor de seleccionar un banco Adquiriente";
                    span.style.display = 'inline';
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegracion?action=SICLIR0300Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="7" align="left" ><font color="#000000">CCN - Reporte de Conciliación Adquirente
                            </font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <a href="javascript:void(0)" onclick="if (self.gfPop)
                                    ...
                                    document.getElementById('bancoAdq').value = 'None';
                        ...
                        <td align="left">
                            ...
                            <span id = "txtEndDate" class="ocultar" class="ocultar">Selecciona una fecha</span>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        ...
                        <td align="left">
                            <%
                                    comboBox = new HTML();
                        out.println( "" + comboBox.getListBox( "bancoAdq", cbBancoAdqValues , "onchange", "sendDataConciliacion('archivosCNN','bancoAdq');removeFiles()","Selecciona un Banco"));
                            %>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4" style="text-align:center;font-size: 11.5px;"><span id = "mensaje" class="ocultar" style="color:red" ></span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
