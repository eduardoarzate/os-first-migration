<%
/*###############################################################################
# Nombre del Programa :  SICMOR0360Header.jsp                                   #
...
<%
   ...
   cbInterRedValues  = myComboBox.getBancoAdqInterRedSinFIltro(session);
   cbBancoEmiValues = myComboBox.getBancoEmi(session);
   cbTipoTrxsValues = myComboBox.getTipoTrxs(session,"1,21");
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletLiqH?action=SICMOR0360HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0360 - Reporte de Transacciones Aceptadas Interredes por Emisor (Detalle)</font></th>
                    </tr>
                    ...
                    <tr> 
                        <td>&nbsp;</td>
                        <td align="left"><strong>Banco Adquiriente:</strong></td>
                        <td align="left">
                            <% comboBox = new HTML();
                               out.println( "" + comboBox.getListBox( "bancoAdq", cbInterRedValues, "Selecciona un Banco" ) );
                            %><br/>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getListBox( "tipoTrans", cbTipoTrxsValues, "Selecciona una Transacción" ) );
                            %><br/>
