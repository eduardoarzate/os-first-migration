<%
/*###############################################################################
# Nombre del Programa :  SICMIR0145Header.jsp                                   #
...
<%
    ...
    cbOut = myComboBox.getLiq(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                {
                    span = document.getElementById('txtout');
                    span.style.display = 'none';
                    showOut = false;
                }
                ...
                } else if (document.frmTOCHeader.bancoAdq.value == "None")
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.out.value == "None")
                {
                    span = document.getElementById('txtout');
                    span.style.display = 'inline';
                    showOut = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletAdquirente?action=SICMIRB145Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIRB145 - Visa / Master Card Outgoing</font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getListBox( "bancoAdq", cbBancoAdqValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left"><strong>Outgoing: </strong></td>
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "outg", cbOut, "Selecciona un Outgoing" ) );
                            %><br/>
                            <span id = "txtout" class="ocultar">Elije una Opción</span>
                        </td>
                    </tr>
