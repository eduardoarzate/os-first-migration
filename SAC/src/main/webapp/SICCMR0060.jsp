<%
// ----------------------------------------------------------------------------
// Nombre del Programa : SICCMR0060.jsp
// Autor               : Manuel Villalobos
// Compania            : GSOF
// Proyecto/Procliente : P-53-2727-14                       Fecha: 23/ENE/2015
// Descripcion General : JSP PARA LA PANTALLA DE REPORTE SICCMR0060
...
<jsp:useBean id="datos" scope="session" class="com.wellcom.struts.SICCMR0060Form"/>
<%
    ...
    <table   width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td id="rightColumns" valign="top" >
                ...
                <form action="ControllerServletCompensacion?action=SICCMR0060" method="post" name="frmTOCHeader" target="_blank">
                                ...
                                <table width="100%" border="0" bordercolor="#FFFFFF">
                                    <tr>
                                        <td class="titulo2" colspan="6">
                                            SICCMR0060 Reporte de la Compensaci&oacute;n C&aacute;maras Prosa
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <select id="camaraAdq" name="camaraAdq" multiple="multiple" size="5">
                                                <option value="-1" selected>Selecciona una Camara</option>
                                                <c:forEach var="elemento" items="${datos.camarasA}">
