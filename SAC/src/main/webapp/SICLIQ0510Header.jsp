...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletReLQ?action=SICLIQ0510Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                ...
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" >
                            <font color="#000000">
                                SICLIQ0510 - Reporte de Partidas sin liquidar<br>
                            </font>
                        </th>
                    </tr>
                    <tr>
