...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICMOR0290Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0290 - Reporte de Cifras de Control de Archivos de Salida (Consolidado)</font></th>
                </tr>
