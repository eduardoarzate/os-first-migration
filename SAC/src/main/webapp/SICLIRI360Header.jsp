<%
/*###############################################################################
# Nombre del Programa :  SICLIRI360Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
...
<%
   ...
   myComboBox = new ComboBoxGen();
    /* Modificacion: Marca de inicio    SAS-DRT F-52-8063-16  */
   cbBancoValues  = myComboBox.getBancoEmiDolConsol(session);   
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletInformativa?action=SICLIRI360Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRI360 - Reporte de Contracargos y Representaciones. Informativa Pesos-D&oacute;lares</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
