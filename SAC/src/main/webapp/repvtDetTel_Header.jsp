...
<%
/*###############################################################################
# Nombre del Programa :  repvtDetTel_Header.jsp  								#
...
<%
        ...
        cbIntValues = myComboBox.getTelefonica(session);
%>
    ...
    <body>
        <div align="center">
           <!--Marca de cambio:  SAS-DRT F-52-8063-16  inicio Modificación -->
            <form action="ControllerServletVTA?action=XXXXrepvtDetTel" method="post"
                ...
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left"><font
                                color="#000000">reporte Detalle Telefonica tiempo Aire</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br /></td>
