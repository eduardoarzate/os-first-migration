<%
/*###############################################################################
# Nombre del Programa :  SICLIR01C0Header.jsp                                   #
# Autor               :  German Gonzalez E.                                     #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  P-06-2233-13                	   FECHA:23/04/2015       #
# Descripcion General :										                    #
#                                                                               #
...
<%
    ...
    cbBancoEmiValues = myComboBox.getBancoAdqSinDolNal(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIRC120Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRC120 - Corresponsales Liquidaci&oacute;n</font></th>
                    </tr>
