<%
/*###############################################################################
# Nombre del Programa :  SICMIR0450Header.jsp                                   #
...
<%
   ...
   cbBancoAdqValues = myComboBox.getBancosAdqsHijos(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegracion?action=SICMIR0450Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR0450 - Reporte Consolidado de Transacciones por Banco</font>  
                        </th>
                    </tr>
