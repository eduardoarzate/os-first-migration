<%
/*###############################################################################
# Nombre del Programa :  SICMORHHeader.jsp                                   	#  
#								MODIFICACIONES                                  #  
# Autor               :  Jorge Tellez Resendiz                                  #  
# Compania            :  SAS				                                    #  
# Proyecto/Procliente :  P-21-0013-16                Fecha: 07/03/2016          #  
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletHub?action=SICMORHMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMORH Detalle de transacciones</font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getListBox( "bancoEmi", cbBancoEmi, "Selecciona un Banco" ) );
                        ...
                        <td>
                            <select name="tipoTransac" id="tipoTransac" multiple="multiple">
                                <option value="None" selected="">Selecciona Tipo Transacci&oacute;n:</option>
