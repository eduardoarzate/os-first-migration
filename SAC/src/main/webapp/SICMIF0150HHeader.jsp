<%
/*###############################################################################
# Nombre del Programa :  SICMIF0150Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegH?action=SICMIF0150HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIF0150 - Consulta Integral de Transacciones Monetarias por Comercio<br></font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getComboBox( "banco", cbBancoAdq, "Selecciona un Banco" ) );
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="left">
                            <input name="btnLstTOC" type="submit" id="btnLstTOC" value="Detalle Tx Electro." onclick="javascript:return valida(this.form);">
                            <input name="btnLstTOC" type="submit" id="btnLstTOC" value="Total Tx Electro." onclick="javascript:return valida(this.form);">
                            <input name="btnLstTOC" type="submit" id="btnLstTOC" value="Detalle Tx Papel" onclick="javascript:return valida(this.form);">
                            <input name="btnLstTOC" type="submit" id="btnLstTOC" value="Total Tx Papel" onclick="javascript:return valida(this.form);">
                            <input name="btnLstTOC" type="submit" id="btnLstTOC" value="Contracargos y Representaciones" onclick="javascript:return valida(this.form);">
                        </td>
                    </tr>
