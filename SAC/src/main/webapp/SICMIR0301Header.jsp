<%
/*###############################################################################
# Nombre del Programa :  SICMIR0300Header.jsp                                   #
...
<%
   ...
   cbBancoEmiValues = myComboBox.getBancoAdqEmi(session);
   cbTipoTxnValues = myComboBox.getTipoTrxsVenDev(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                {
                    span = document.getElementById('txtTipoTxn');
                    span.style.display = 'none';
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegracion?action=SICMIR0301Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR0301 - Reporte Integral de Transacciones de EmisorAdquiridas por Bancomer/Banamex<br></font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <% 
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getListBox( "tipoTxn", cbTipoTxnValues, "Selecciona un Tipo Transacción") );
                            %>
                            <br/>
                            <span id = "txtTipoTxn" class="ocultar">Elije una Opción</span>
                        </td>
