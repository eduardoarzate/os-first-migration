...
<%
    ...
    myComboBox = new ComboBoxGen();
        ...
        cbBANCO = myComboBox.getBancoAdqEmiSinEglo(session);	
        cbTIPO = myComboBox.getEmiAdq(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletExt?action=SICLIR0560Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0560 - Reporte de Transacciones Extempor&aacute;neas <br></font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
           ...
           out.println( "" + comboBox.getListBox( "banco", cbBANCO, "Selecciona un Banco" ) );
                        ...
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getComboBox( "tipo", cbTIPO, "Selecciona el tipo de banco" ) );
                            %><br/>
