...
<html>
    ...
    %>
		<birt:viewer 
			id="birtViewer" 
			reportDesign="<%=getServletContext().getInitParameter(\"UBICACION_REPORTES\")+\"/SICLIQ0500.rptdesign\"%>"
			showParameterPage="false" 
			showTitle="true" 
			pattern="frameset"
			format="HTML" 
			isHostPage="true" 
			title="SISTEMA ADQUIRENTE CARNET SAC 2 SICLIQ0500" 
			showToolBar="true" 
		>
