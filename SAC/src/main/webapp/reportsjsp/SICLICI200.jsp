<%
/*##############################################################################
# Nombre del Programa : SICLICI200.jsp                                         #
...
<html>
  ...
  <body>
    ...
    %>
    <birt:viewer id="birtViewer" reportDesign="<%=getServletContext().getInitParameter(\"UBICACION_REPORTES\")+\"/SICLICI200.rptdesign\"%>"
      showParameterPage="false" showTitle="true" pattern="frameset"
      format="HTML" isHostPage="true" title="SISTEMA ADQUIRENTE CARNET SAC 2 SICLICI200" showToolBar="true">
