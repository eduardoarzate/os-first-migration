...
/*
################################################################################
# Nombre del Programa : SICLICE300.jsp                                         #
...
<html>
  ...
  <body>
    <%
      ...
      System.out.println("fuente antes de los ifs "+fuente);
      if (fuente == null || fuente == "")
         fuente = "0";
      
      ejecuto= session.getAttribute("login").toString();
      System.out.println("parametros fecha inicio "+initDate+"\n fecha final "+endDate+"\n suparticion "+suparticion+"\n bancoAdq "+bancoAdq+"\n bancoEmi "+bancoEmi+
                         "\n fuente "+fuente+"\n ejecuto "+ejecuto );
    %>
    <birt:viewer
      id                = "birtViewer"
      reportDesign      = "<%=getServletContext().getInitParameter(\"UBICACION_REPORTES\")+\"/SICLICE300.rptdesign\"%>"
      showParameterPage = "false"
      showTitle         = "true"
      pattern           = "frameset"
      format            = "HTML"
      isHostPage        = "true"
      title             = "SISTEMA ADQUIRENTE CARNET SAC 2 SICLICE300"
      showToolBar       = "true"
    >
