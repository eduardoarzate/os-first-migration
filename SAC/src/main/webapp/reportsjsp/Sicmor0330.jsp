<%
/*###############################################################################
# Nombre del Programa :  SICMOR0330.jsp											#
	...
	<body>
		<% 
                    ...
                    bancoAdq=session.getAttribute("bancoAdq").toString();
   				    tipoTxn=session.getAttribute("tipoTxn").toString();
                    natContable=session.getAttribute("natContable").toString();
		%>
		<birt:viewer  id="birtViewer" reportDesign="<%=getServletContext().getInitParameter(\"UBICACION_REPORTES\")+\"/sicmor0330.rptdesign\"%>"
			showParameterPage="false" showTitle="true" pattern="frameset"
			format="HTML" isHostPage="true" title="SISTEMA ADQUIRENTE CARNET SAC 2 SICMOR0330" showToolBar="true" >
			...
			<birt:param name="tipoTxn" value="<%=tipoTxn%>" />
			<birt:param name="natContable" value="<%=natContable%>" />
