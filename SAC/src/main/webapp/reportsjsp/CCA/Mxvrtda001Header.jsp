<%
/*###############################################################################
# Nombre del Programa :  Mxvrtda001Header.jsp    								#
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletClick?action=Mxvrtda001Main" method="post"
                ...
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left"><font
                                color="#000000">Mxvrtda001 - Reporte de Transacciones Clicash (Acumulado por Banco)</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br /></td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input type="checkbox" name="tasaMxvrtda" title="Mostrar Sobresatasa" >
                            <br/>
                        </td>
                    </tr>
                    <tr>
