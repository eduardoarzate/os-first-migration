<%
/*###############################################################################
# Nombre del Programa :  Mxvrtda001.jsp						#
...
<html>
	...
	<body>
		...
		Emisor = (String)session.getAttribute("Emisor");
                ...
                tasaMxvrtda = (String)session.getAttribute("tasaMxvrtda");
		%>
		<birt:viewer id="birtViewer" reportDesign="<%=getServletContext().getInitParameter(\"UBICACION_REPORTES\")+\"/Mxvrtda001.rptdesign\"%>"
			showParameterPage="false" showTitle="true" pattern="frameset"
			format="HTML" isHostPage="true" title="Reporte de Transacciones Clicash (Acumulado por Banco)" showToolBar="true">
			...
			<birt:param name="tasaMxvrtda" value="<%=tasaMxvrtda%>" />
		</birt:viewer>
