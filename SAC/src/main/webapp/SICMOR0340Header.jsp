<%
/*###############################################################################
# Nombre del Programa :  SICMOR0340Header.jsp                                   #
...
<%
   ...
   cbIntValues=myComboBox.getBancoAdqEmiConsol(session);
   cbIntValues2=myComboBox.getBancosEglo(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMonitoreo?action=SICMOR0340Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id= "tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0340 - Reporte de Rechazos de Sintaxis por Emisor</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
           ...
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getListBox( "bancoAdq", cbIntValues2, "Selecciona un Banco" ) );
                            %><br/>
