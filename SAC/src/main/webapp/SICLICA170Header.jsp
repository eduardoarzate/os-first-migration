...
# Modificacion        : Reporte Consolidado Corresponsales Adquirente          #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLICA170Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLICA170 - Reporte Consolidado Corresponsales Adquirente</font>
                        </th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
                              comboBox = new HTML();
                              out.println( "" + comboBox.getListBox( "bancoAdq", cbAdquirente, "onchange", "javascript:sendDatas('bancoAdq','txtfStartDate','corresponsal','comboBoxArchivo');","Seleciona Un Banco" ) );
                            %><br/>
