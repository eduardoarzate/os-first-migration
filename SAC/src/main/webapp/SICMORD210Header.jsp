<%
/*###############################################################################
# Nombre del Programa :  SICMOR0210Header.jsp                                   #
...
<%
   ...
   cbBancoAdqValues = myComboBox.getBancoEmiLiqDol(session);
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextTipoRechazo)
                {
                    span = document.getElementById('txtTipoRechazo');
                    span.style.display = 'none';
                    showTextTipoRechazo = false;
                ...
                } else if (document.frmTOCHeader.txtfEndDate.value == "" || document.frmTOCHeader.txtfEndDate.value == null)
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.typeRech.value == "None")
                {
                    span = document.getElementById('txtTipoRechazo');
                    span.style.display = 'inline';
                    showTextTipoRechazo = true;
                    return false;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletEmisorDolares?action=SICMORD210Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMORD210 - Reporte de Transacciones Rechazadas  
                            </font></th>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Tipo Rechazo:</strong></td>
                        <td align="left">
                            <% 
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getComboBox( "typeRech", cbTipoRechValues, "Selecciona un Rechazo") );
                            %>
                            <br/>
                            <span id = "txtTipoRechazo" class="ocultar">Elije una Opción</span>
                        </td>
