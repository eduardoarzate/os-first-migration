<%
// ----------------------------------------------------------------------------
// Nombre del Programa : SICCMR0065.jsp
// Autor               : Manuel Villalobos
// Compania            : GSOF
// Proyecto/Procliente : P-53-2727-14                       Fecha: 23/ENE/2015
// Descripcion General : JSP PARA LA PANTALLA DE REPORTE SICCMR0065
...
<jsp:useBean id="datos" scope="session" class="com.wellcom.struts.SICCMR0065Form"/>
<%
...
<html>
    ...
    <script language="javascript">
        ...
        {
            if (document.forms[0].banco.value == "-1") {
    ...
    <table   width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td id="rightColumns" valign="top" >
                ...
                <form action="ControllerServletCompensacion?action=SICCMR0065" method="post" name="frmTOCHeader" target="_blank">
                                ...
                                <table width="100%" border="0" bordercolor="#FFFFFF">
                                    <tr>
                                        <td class="titulo2" colspan="6">
                                            SICCMR0065 Consulta de Saldos C&aacute;mara por Grupo
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" width="230px">
                                            ...
                                            <a href="javascript:void(0)" onclick="if (self.gfPop)
                                                        gfPop.fPopCalendar(document.frmTOCHeader.fechaFinal);return false;" hidefocus>
                                                <img name="popcalStart" align="absmiddle" src="scripts/calendar/calbtn.jpg" border="0" alt="">
                                            </a><br/>
                                        </td>
                                        <td class="etiquetaListado" width="110px">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <select id="banco" name="banco" multiple="multiple" size="10">
                                                <option value="-1" selected>Selecciona un Banco</option>
                                                <c:forEach var="elemento" items="${datos.bancos}">
