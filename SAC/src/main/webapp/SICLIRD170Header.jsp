<%
/*###############################################################################
# Nombre del Programa :  SICLIRD170Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletEmisorDolares?action=SICLIRD170Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRD170 - Totales del Intercambio Internacional D&oacute;lares<br></font></th>
                    </tr>
