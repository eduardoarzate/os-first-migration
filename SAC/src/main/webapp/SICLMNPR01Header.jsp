<%
/*###############################################################################
# Nombre del Programa :  SICLMNPR01Header.jsp		    						#
...
<%
        ...
        HTML htmlCmb;
        /* Modificacion: Marca de inicio    SAS-DRT F-52-8063-16  */        ComboBoxGen comboBox;
    if(!ga.AccessGranted(session, "grantAccess")){
        response.sendRedirect("login.jsp");
    }
   comboBox = new ComboBoxGen();    /* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */
   htmlCmb = new HTML();
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form name="frmTOCHeader" id="frmTOCHeader" target="mainFrameTOC" method="post" action="ControllerServletInterf?action=SICLMNPR01Main">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLMNPR01 - Reporte Consolidado de Bancos Socios de la Liquidaci&oacute;n de Interredes (por marca)<br></font></th>
                    </tr>
