...
# Modificación        : AXIA-GGB-P-04-3027-13                                 #
#------------------------------------------------------------------------------#
...
*/
   ...
   cbo = myComboBox.getBancoAdqEmiConsol(session);
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMasVi?action=SICMIR0127_LIVMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                ...
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" >
                            <font color="#000000">SICMIR0128 - Reportes Visa</font>
                            <br>
                        </th>
                    </tr>				
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%  inputText = new HTML();
                                out.println( "" + inputText.getComboBox( "banco", cbo,"Seleccione un Banco" ));
                            %>
                            <br/>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="3" width="20%">
                            <input type="radio" name="corte" value="1" checked>001 APR5100M<br>
                            <input type="radio" name="corte" value="2">002 BIOSR112<br>
                            <input type="radio" name="corte" value="3">003 BIOSR600<br>
                            <input type="radio" name="corte" value="4">004 CVV11000<br>
                            <input type="radio" name="corte" value="5">005 CVV1110<br>
                            <input type="radio" name="corte" value="6">006 IARS100<br>
                            <input type="radio" name="corte" value="7">007 IARS100D<br>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
