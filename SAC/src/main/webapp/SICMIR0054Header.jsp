<%
/*###############################################################################
# Nombre del Programa :  SICMIR0054Header.jsp                                   #
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextArchivoEmi)
                {
                    span = document.getElementById('txtArchivoEmi');
                    span.style.display = 'none';
                    showTextArchivoEmi = false;
                }
                ...
                } else if (document.frmTOCHeader.bancoEmi.value == "None")
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.archivoEmi.value == "None")
                {
                    span = document.getElementById('txtArchivoEmi');
                    span.style.display = 'inline';
                    showTextArchivoEmi = true;
                    return false;
                } else
                {
                    return true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegracion?action=SICMIR0054Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR0054 - Reporte Cifras Control de Archivos a Transmitir   
                            </font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <% 
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getListBox( "bancoEmi", cbBancoEmiValues , "onchange", "javascript:sendData('bancoEmi','archivo0054','comboBoxArchivo');","Selecciona un Banco"));
                            %><br/>
                        ...
                        <td align="left" id="comboBoxArchivo">
                            <select>
                                <option selected="selected" value="None">Seleccionan un Archivo</option>
                            </select>          	 	
                        </td> 
                    </tr>
