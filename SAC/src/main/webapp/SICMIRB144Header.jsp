<%
/*###############################################################################
# Nombre del Programa :  SICMIRB144Header.jsp                                   #
...
<%
    ...
    myComboBox = new ComboBoxGen();
        ...
        cbIntValues = myComboBox.getIca2(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletAdquirente?action=SICMIRB144Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIRB144 - Combinación Charbacks - Receptor(Internacional)</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>ICA ADquirente:</strong></td>
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un ICA" ) );
                            %><br/>
