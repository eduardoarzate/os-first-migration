<%
/*###############################################################################
# Nombre del Programa :  SICLIR0105Header.jsp                                   #
...
<%
	...
	cbIntValues = myComboBox.getBancoEmiBancoFacil(session); 
%>
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICLIR0105Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0105 -Reporte de Liquidaci&oacute;n Banco F&aacute;cil Paguitos</font></th>
                </tr>
				<tr>
					<td>&nbsp;</td>
					<td colspan="4"><br/></td>
