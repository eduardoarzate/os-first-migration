...
<%
    ...
    cbBco = myComboBox.getBancoAdqDol(session);    
%>
...
<html>
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextBanco)
                {
                    ...
                    span.style.display = 'none';
                    showTextBanco = false;
                } else if (showTextComercio)
                {
                    span = document.getElementById('spamcomercio');
                    span.style.display = 'none';
                    showTextComercio = false;
                }
                ...
                if (document.frmTOCHeader.txtfStartDate.value == "" || document.frmTOCHeader.txtfStartDate.value == null)
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.banco.value == "" || document.frmTOCHeader.banco.value == null)
                {
                    span = document.getElementById("txtBancoAdq");
                    span.style.display = 'inline';
                    showTextBanco = true;
                    return false;
                } else if (document.frmTOCHeader.scomercio.value == "" || document.frmTOCHeader.scomercio.value == null)
                {
                    span = document.getElementById("spamcomercio");
                    span.style.display = 'inline';
                    showTextComercio = true;
                    return false;
                } else
                {
                    return true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletAdquiH?action=SICMIRB040HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIRB040H - Reporte Integral&nbsp; de Transacciones por comercio</font></th>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Fecha proceso:</strong></td>
                        <td align="left">
                        ...
                        <td align="left">
                            <% 
                                    comboBox = new HTML();
                            //out.println( "" + comboBox.getListBox( "banco", cbBco , "onchange", "javascript:sendData('banco','cargacomercio','comercio');","Selecciona un Banco"));
                            out.println( "" + comboBox.getListBox( "banco", cbBco , "Selecciona un Banco"));
                            %><br/>
                    ...
                    <tr>
                        ...
                        <td align="left" id="comercio">
                            <% inputText = new HTML();
                               out.println( "" + inputText.getinputText("scomercio",16,20));
                            %><br/>
                            <span id = "spamcomercio" class="ocultar">Ingrese un Comercio</span>    	 	
                        </td>                 	 	 
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
