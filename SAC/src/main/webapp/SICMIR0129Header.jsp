...
<%
/*
# Nombre del Programa :  SICMIR0129Header.jsp                                   #
...
*/
   ...
   //cbBCOEMI = myComboBox.getBinInternacionEntidad(session);   
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMasVi?action=SICMIR0129Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">REP_127_MI - Reportes Mercados Internacionales</font><br></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <tr>
                        ...
                        <td align="left"><strong>Banco (BINES Mercados Internacionales):</strong></td>
                        <td align="left" id="bancoBin">
                            <%
                                  //  inputText = new HTML();
                                   // out.println( "" + inputText.getComboBox( "banco", cbBCOEMI,"Seleccione un Banco (BINES)" ) );
                            %><br/>
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="left">
                            <input name="btnLstTOC" type="button" id="btnLstBines" value="Cargar Bines" onclick="javascript:return sendDat1();">
