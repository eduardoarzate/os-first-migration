<%
/*###############################################################################
# Nombre del Programa :  SICMIR0124Header.jsp                                   #
...
<%ArrayList cbIntValues,cbTiposCharbacks;
        HTML comboBox;
...
<%
    ...
    /* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */
        ...
        cbTiposCharbacks = myComboBox.getTTCharbacks(session);
%>
...
<html>
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextBanco)
                {
                    ...
                    span.style.display = 'none';
                    showTextBanco = false;
                } else if (showTextTtCharbacks)
                {
                    span = document.getElementById('txtTtCharbacks');
                    span.style.display = 'none';
                    showTextTtCharbacks = false;
                }
                ...
                } else if (document.frmTOCHeader.banco.value == "None")
                {
                    ...
                    showTextBanco = true;
                    return false;
                } else if (document.frmTOCHeader.ttCharbacks.value == "None")
                {
                    span = document.getElementById('txtTtCharbacks');
                    span.style.display = 'inline';
                    showTextTtCharbacks = true;
                    return false;
                } else
                {
                    return true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMasVi?action=SICMIR0124Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR0124 - Combinaci&oacute;n Chargebacks - Receptor(Internacional)</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
           ...
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left"><strong>Tipos Transacción:</strong></td>
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getListBox( "ttCharbacks", cbTiposCharbacks , "Selecciona un tipo transacción" ) );
                            %><br/>
                            <span id = "txtTtCharbacks" class="ocultar">Elije una Opción</span>
                        </td>
                    </tr>
