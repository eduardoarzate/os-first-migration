...
<%
/*###############################################################################
# Nombre del Programa :  repvtDetAdq_Header.jsp  								#
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletVTA?action=XXXXrepvtDetAdq" method="post"
                ...
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left"><font
                                color="#000000">reporte Detalle Adquiriente tiempo Aire</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br /></td>
