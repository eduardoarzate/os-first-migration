<%
/*###############################################################################
# Nombre del Programa :  SICLIR0350Header.jsp                                   #
...
<%ArrayList cbBancoValues;
        ArrayList cbNumMisc;
        ArrayList cbTipoProc;
        ArrayList cbTipoEmiAdq;
        HTML comboBox;
...
<%
   ...
   cbBancoValues  = myComboBox.getBancoAdqEmi(session);
   cbNumMisc=myComboBox.getMiscelaneos(session);
   cbTipoProc=myComboBox.getTipoProc(session);
   cbTipoEmiAdq=myComboBox.getEmiAdq2(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        var showTextTipoProc = false;
        var showFavor = false;
        var showTextNumMisc = false;
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextBanco)
                {
                    ...
                    span.style.display = 'none';
                    showTextBanco = false;
                } else if (showTextTipoProc)
                {
                    span = document.getElementById('txtTipoProc');
                    span.style.display = 'none';
                    showTextTipoProc = false;
                } else if (showTextNumMisc)
                {
                    span = document.getElementById('txtNumMisc');
                    span.style.display = 'none';
                    showTextNumMisc = false;
                } else if (showFavor)
                {
                    span = document.getElementById('txtFavor');
                    span.style.display = 'none';
                    showFavor = false;
                }
                ...
                } else if (document.frmTOCHeader.banco.value == "None")
                {
                    ...
                    showTextBanco = true;
                    return false;
                } else if (document.frmTOCHeader.numMisc.value == "None")
                {
                    span = document.getElementById('txtNumMisc');
                    span.style.display = 'inline';
                    showTextNumMisc = true;
                    return false;
                } else if (document.frmTOCHeader.tipoProc.value == "None")
                {
                    span = document.getElementById('txtTipoProc');
                    span.style.display = 'inline';
                    showTextTipoProc = true;
                    return false;
                } else if (document.frmTOCHeader.tipoEmiAdq.value == "None")
                {
                    span = document.getElementById('txtFavor');
                    span.style.display = 'inline';
                    showFavor = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0350Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0350 - Reporte de Miscel&aacute;neos</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getListBox( "banco",  cbBancoValues, "Selecciona un Banco"  ) );
                            %><br/>
                            <span id = "txtBanco" class="ocultar">Elije una Opción</span>
                        </td>
                        <td align="left"><strong>Miscel&aacute;neo:</strong></td>
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getListBox( "numMisc",  cbNumMisc, "Selecciona un Misceláneo"  ) );
                            %><br/>
                            <span id = "txtNumMisc" class="ocultar">Elije una Opción</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "tipoProc",  cbTipoProc, "Selecciona un Tipo de Proceso"  ) );
                            %><br/>
                            <span id = "txtTipoProc" class="ocultar">Elije una Opción</span>
                        </td>
                        <td align="left"><strong>Agrupar por Totales:</strong></td>
                        <td align="left">
                            <input type="checkbox" name="agrTotales" title="Agrupar por Totales" >
                            <br/>
                            <span id = "txtBanco" class="ocultar">Elije una Opción</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>A favor de:</strong></td>
                        <td align="left">
                            <%out.println( "" + comboBox.getComboBox( "tipoEmiAdq",  cbTipoEmiAdq, "Selecciona un Tipo"  ) );%>
                            <br/>
                            <span id = "txtFavor" class="ocultar">Elije una Opción</span>
                        </td>
                        <td colspan="2"><br/></td>
                    </tr>
