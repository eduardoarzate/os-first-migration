...
<%
   ...
   cbArchivoEntrada = myComboBox.getArchivoEntrada(session);   
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICMOR0240Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0240 - Reporte de Integraci&oacute;n de Fuentes<br></font></th>
                </tr>
				...
				<tr>
					...
					<tr>
                        ...
                        <td align="left">
                                <%
	                        	comboBox = new HTML();
	                        	out.println( "" + comboBox.getListBox( "fuente",  cbArchivoEntrada, "Selecciona una Fuente"  ) );
	                        %><br/>
