<%
/*###############################################################################
# Nombre del Programa :  SICLIF0666Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICLIF0666Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" class="tbl_border">
                <tr>
                   <th class= "td_header" width="100%" colspan="5" align="left" >SICLIF0666 - Reporte de Entrenamiento</th>
                </tr>
				<tr>
					<td>&nbsp;</td>
					<td colspan="4"><br/></td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                                ...
                                <span id = "txtInitDate">Selecciona una fecha</span>
                        </td>
                        ...
                        <td align="left">
                                ...
                                <span id = "txtEndDate">Selecciona una fecha</span>
                        </td>
                    </tr>
  					...
  					<tr>
  						...
  						<td align="left">
  							 <%
	                        	htmlComponente = new HTML();
	                        	out.println( "" + htmlComponente.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
	                        %><br/>
	                        <span id = "txtBanco">Elije una Opción</span>
  						</td>
  						<td><br/></td>
  						<td><br/></td>
  					</tr>
