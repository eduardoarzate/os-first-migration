<%
/*###############################################################################
# Nombre del Programa :  SICLIR0100SSATHeader.jsp                               #
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICLIR0100CSATMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0100CSAT - Reporte de Control SAT</font></th>
                </tr>
				...
				<tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
	                        ...
	                        %><br/>
	                        <span id = "txtNoCuenta" class="ocultar">No. de Cuenta Invalida </span>
                        </td>
                           <td align="left"><strong>Autorizacion:</strong></td>
                        <td align="left">
                                <%
	                        	inputText = new HTML();
	                        	out.println( "" + inputText.getinputText( "autorizacion", 20,20 ) );
	                        %><br/>
                        </td>
                    </tr>
