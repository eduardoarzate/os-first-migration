...
<%
        ...
        cbIntValues = myComboBox.getTelefonicaMantenimiento(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            <!--Modificacion: SAS-DRT F-52-8063-16 Marca de inicio-->
            <form action="ControllerServletHerr?action=XXXXmntoTel" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Modificacion: SAS-DRT F-52-8063-16 Marca de fin-->                  
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left"><font
                                color="#000000">Mantenimiento Telefonica</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br /></td>
                    ...
                    <tr>
                            ...
                            <td align="left"><input name="txtfStartDate" type="text"
                                    ...
                                    onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmTOCHeader.txtfStartDate);return false;"
            ...
            <td align="left"><input name="txtfEndDate" type="text"
                    ...
                    value=<%=session.getAttribute("fechaHoy")%>> <a
                    href="javascript:void(0)"
                    onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmTOCHeader.txtfEndDate);return false;"
                    hidefocus> <img name="popcalStart" align="absmiddle"
                            src="scripts/calendar/calbtn.jpg" border="0" alt="">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>Telefonica:</strong></td>
                        <td align="left">
                            <%
                                    comboBox = new HTML();
                                    out.println(""
                                                    + comboBox.getListBox("telefonica", cbIntValues,
                                                                    "Selecciona una Telefonica"));
