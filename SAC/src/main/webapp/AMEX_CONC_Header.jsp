...
<%
    ...
    myComboBox = new ComboBoxGen();    
        cbTipoConc= myComboBox.getOpcionesConc(session);
...
<html>
        ...
        function valida()
        {
            try
            {
                ...
                } else if (document.frmTOCHeader.txtfEndDate.value == "" || document.frmTOCHeader.txtfEndDate.value == null)
                {
                    ...
                    showTextBanco = true;
                    return false;
                }else if (document.frmTOCHeader.tipoTransaccion.value == "None" || document.frmTOCHeader.tipoTransaccion.value == null){
                    span = document.getElementById('txtTipoLiq');
                    span.style.display = 'inline';
                    showTipoLiq = true;
                    return false;
    ...
    <body>
        <div align="center">
            <form action="ControllerServletAmex?action=repConcProsaAmexMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">  - Reporte de Conciliaci&oacute;n AMEX   
                            </font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
           ...
           out.println( "" + inputText.getinputText( "numeroIndustria", 20,20 ) );
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
                                    HTML cb = new HTML();
                                    out.println( "" + cb.getComboBox( "tipoTransaccion", cbTipoConc, "Selecciona un tipo de transacción." ) );
                            %><br/>
                            <span id = "txtTipoLiq" class="ocultar">Selecciona Opción</span>
                        </td>

                        <td align="left"><strong>Tipo Reporte :</strong></td>
                        <td align="left">
                            <input type="radio" name="tipoReporte" value="D" checked> DETALLE
                            <input type="radio" name="tipoReporte" value="T"> TOTALES 
                        </td>                        
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
...
<div align="center">	
    <div align="center" class="errorBody">
        <div style="position:relative;margin:0 auto;">
            <span style="font-size:28px;color:#FF0022;font-weight:bold;">No tiene permiso para visualizar este reporte (Reporte de Conciliaci&oacute;n AMEX).</span></div>
    </div>
</div>
<div align="center">
