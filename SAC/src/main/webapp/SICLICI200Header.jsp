...
<html>
        ...
        <script type="text/javascript">
            ...
            function valida()
            {
                try
                {
                    ...
                    {
                        span = document.getElementById("txtfEndDate");
                        span.style.display = 'none';
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLICI200Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLICI200 - Reporte Corresponsales Detalle integradores</font>  
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left"> 
                            ...
                            %>
                            <span id = "spamNaturaleza" class="ocultar">Elija una Opción</span>                 	 							
                        </td>                                  
