<%
/*###############################################################################
# Nombre del Programa :  SICLIR0170Header.jsp                                   #
# Autor               :  JOSE ANDRES CASTILLO MORENO                            #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  P-08-299-04                 	   FECHA:21/09/2010     #
# Descripcion General :										                    #
#                                                                               #
...
<%
    ...
    cbTipoMoneda = myComboBox.getTipMoneda(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0170Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0170 - Consolidado de la Compensaci&oacute;n Visa/Mastercard<br></font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "moneda", cbTipoMoneda, "Selecciona un Tipo de Moneda" ) );
                            %><br/>
                            <span id = "txtTipoMoneda" class="ocultar">Elije una Opción</span>
                        </td>
                        <td><br/></td>
                        <td><br/></td>
                    </tr>
