<%
/*###############################################################################
# Nombre del Programa :  SICLIR0050Header.jsp                                   #
# Autor               :  CARLOS MENDEZ                                          #
# Compania            :  PROSA                                                  #
...
<%
    ...
    myComboBox = new ComboBoxGen();
     /* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */
        cbIntValues = myComboBox.getBancoEmiDolConsol(session); 
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletInformativa?action=SICLIRI050Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRI050 - Liquidaci&oacute;n Entrante. Informativa Pesos-D&oacute;lares</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
           ...
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left"><strong>Agrupar Tipo de Transacci&oacute;n:</strong></td>
                        <td align="left">
                            <input type="checkbox" name="agrupacion" title="Reporte Integral de Transacciones Adquiridas por Bancomer/Banamex/E-Global" >
                            <br/>
                            <span id = "txtBanco" class="ocultar">Elije una Opción</span>
                        </td>
