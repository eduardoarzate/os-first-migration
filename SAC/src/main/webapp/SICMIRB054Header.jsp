...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextArchivoAdq)
                {
                    span = document.getElementById('txtArchivoAdq');
                    span.style.display = 'none';
                    showTextArchivoAdq = false;
                }
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletAdquirente?action=SICMIRB054Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIRB054 - Reporte Cifras Control de Archivos a Transmitir   
                            </font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <% 
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getListBox( "bancoAdq", cbBancoAdqValues , "onchange", "javascript:sendData('bancoAdq','archivob054','comboBoxArchivo');","Selecciona un Banco"));
                            %><br/>
