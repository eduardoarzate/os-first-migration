<%
// ----------------------------------------------------------------------------
// Nombre del Programa : SICCMRC200.jsp
// Autor               : Manuel Villalobos
// Compania            : GSOF
// Proyecto/Procliente : P-53-2727-14                       Fecha: 23/ENE/2015
// Descripcion General : JSP PARA LA PANTALLA DE REPORTE SICCMRC200
...
<jsp:useBean id="datos" scope="session" class="com.wellcom.struts.SICCMRC200Form"/>
<%
    ...
    <table   width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td id="rightColumns" valign="top" >
                ...
                <form action="ControllerServletCompensacion?action=SICCMRC200" method="post" name="frmTOCHeader" target="_blank">
                                ...
                                <table width="100%" border="0" bordercolor="#FFFFFF">
                                    <tr>
                                        <td class="titulo2" colspan="6">
                                            SICCMRC200 Reporte Consolidado Total por C&aacute;maras de Compensaci&oacute;n
                                        </td>
                                    </tr>
