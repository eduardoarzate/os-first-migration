<%
/*###############################################################################
# Nombre del Programa :  SICDCC0050Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICDCC0050Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICDCC0050 Consolidado de Liquidación DCC por Entidad Fintrax vs Prosa</font></th>
                </tr>
