...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServletAmex?action=rptAmexEpapeAjustesMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">  - Reporte de EPAPE AMEX Ajustes  
                            </font></th>
                    </tr>
...
<div align="center">	
    <div align="center" class="errorBody">
        <div style="position:relative;margin:0 auto;">
            <span style="font-size:28px;color:#FF0022;font-weight:bold;">No tiene permiso para visualizar este reporte (Reporte de EPAPE AMEX Ajustes).</span></div>
    </div>
</div>
<div align="center">
