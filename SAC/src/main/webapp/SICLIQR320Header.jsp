...
/*
################################################################################
# Nombre del Programa : SICLIQR320Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletReLQ?action=SICLIQR320Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                ...
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" >
                            <font color="#000000">
                                SICLIQR320 - Reporte Recalculo Consolidado de Saldos Diarios
                            </font>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      return false;" hidefocus>
                            ...
                            <br/>
                            <span id = "txtInitDate" class="ocultar">
                      ...
                      return false;" hidefocus>
                            ...
                            <br/>
                            <span id = "txtEndDate" class="ocultar">
                                Selecciona una fecha
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            ...
                            %>
                            <br/>
                            <span id = "txtTipoLiq" class="ocultar">
                                Selecciona Opción
                            </span>
                        </td>
                    </tr>
