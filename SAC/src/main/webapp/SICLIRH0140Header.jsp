<%
/*###############################################################################
# Nombre del Programa :  SICLIRH0140Header.jsp		    						#
...
<%
   ...
   cbBancoEmi=myComboBox.getBancoAdqEmiConsol(session);
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletHub?action=SICLIRH0140Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRH0140 - Reporte liquidacion HUBCARNET vista Adquirientes<br></font></th>
                    </tr>
