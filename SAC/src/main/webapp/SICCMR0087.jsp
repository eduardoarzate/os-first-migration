<%
// ----------------------------------------------------------------------------
// Nombre del Programa : SICCMR0087.jsp
// Autor               : Manuel Villalobos
// Compania            : GSOF
// Proyecto/Procliente : P-53-2727-14                       Fecha: 02/AGO/2016
// Descripcion General : JSP PARA LA PANTALLA DE REPORTE SICCMR0087
...
<jsp:useBean id="datos" scope="session" class="com.wellcom.struts.SICCMR0087Form"/>
<%
    ...
    <table   width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td id="rightColumns" valign="top" >
                ...
                <form action="ControllerServletCompensacion?action=SICCMR0087" method="post" name="frmTOCHeader" target="_blank">
                                ...
                                <table width="100%" border="0" bordercolor="#FFFFFF">
                                    <tr>
                                        <td class="titulo2" colspan="6">
                                            SICCMR0087 Reporte Consolidado C&aacute;mara E-Global
                                        </td>
                                    </tr>
