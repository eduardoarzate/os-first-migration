<%
// ----------------------------------------------------------------------------
// Nombre del Programa : SICCMRC320.jsp
// Autor               : Manuel Villalobos
// Compania            : GSOF
// Proyecto/Procliente : P-53-2727-14                       Fecha: 29/JUL/2016
// Descripcion General : JSP PARA LA PANTALLA DE REPORTE SICCMRC320
...
<jsp:useBean id="datos" scope="session" class="com.wellcom.struts.SICCMRC320Form"/>
<%
    ...
    <table   width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td id="rightColumns" valign="top" >
                ...
                <form action="ControllerServletCompensacion?action=SICCMRC320" method="post" name="frmTOCHeader" target="_blank">
                                ...
                                <table width="100%" border="0" bordercolor="#FFFFFF">
                                    <tr>
                                        <td class="titulo2" colspan="6">
                                            SICCMRC320 Reporte Consolidado de Saldos por C&aacute;mara de Compensaci&oacute;n
                                        </td>
                                    </tr>
