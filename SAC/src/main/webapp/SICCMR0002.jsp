<%
// ----------------------------------------------------------------------------
// Nombre del Programa : SICCMR0002.jsp
// Autor               : Manuel Villalobos
// Compania            : GSOF
// Proyecto/Procliente : P-53-2727-14                       Fecha: 29/JUL/2016
// Descripcion General : JSP PARA LA PANTALLA DE REPORTE SICCMR0002
...
<jsp:useBean id="datos" scope="session" class="com.wellcom.struts.SICCMR0002Form"/>
<%
...
<html>
    ...
    <script language="javascript">
        ...
        {
            if (document.forms[0].marca.value == "-1") {
                alert("Debe elegir una Marca");
                return false;
            }
    ...
    <table   width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td id="rightColumns" valign="top" >
                ...
                <form action="ControllerServletCompensacion?action=SICCMR0002" method="post" name="frmTOCHeader" target="_blank">
                                ...
                                <table width="100%" border="0"  bordercolor="#FFFFFF">
                                    <tr>
                                        <td class="titulo2" colspan="6">
                                            SICCMR0002 Reporte Batch para Titulares de Marca
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <select id="marca" name="marca" multiple="multiple" size="5">
                                                <option value="-1" selected>Selecciona una Marca</option>
                                                <c:forEach var="elemento" items="${datos.marcas}">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <select id="bancoAdq" name="bancoAdq" multiple="multiple" size="10">
                                                <option value="-1" selected>Selecciona un Adquirente</option>
                                                <c:forEach var="elemento" items="${datos.bancosA}">
                                                    <option value='<c:out value="${elemento.clave}"/>'> <c:out value="${elemento.descripcion}"/></option>
                                                </c:forEach>
                                            </select>
                                        </td>
