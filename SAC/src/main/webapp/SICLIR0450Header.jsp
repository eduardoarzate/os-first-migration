<%
/*###############################################################################
# Nombre del Programa :  SICLIR0450Header.jsp                                   #
...
<%
    ...
    /* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */
        cbIntValues = myComboBox.getBancosEglo(session); 
        cbTipoDifVal=myComboBox.getTipoDif(session);
%>
...
<html>
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextBanco)
                {
                    ...
                    span.style.display = 'none';
                    showTextBanco = false;
                } else if (showTextTipoDif) {
                    span = document.getElementById('txtTipoDif');
                    span.style.display = 'none';
                    showTextTipoDif = false;
                }
                ...
                } else if (document.frmTOCHeader.banco.value == "None")
                {
                    ...
                    showTextBanco = true;
                    return false;
                } else if (document.frmTOCHeader.tipoDif.value == "None")
                {
                    span = document.getElementById('txtTipoDif');
                    span.style.display = 'inline';
                    showTextTipoDif = true;
                    return false;
                } else
                {
                    return true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0450Main" method="post" target="mainFrameTOC"  name="frmTOCHeader"   id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0450 -Reporte de Diferencias de Comisiones de E-Global</font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
           ...
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left"><strong>Tipo de Diferencia:</strong></td>
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getComboBox( "tipoDif", cbTipoDifVal, "Selecciona una Diferencia" ) );
                            %><br/>
                            <span id = "txtTipoDif" class="ocultar">Elije una Opción</span>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left"><strong>No. Cuenta (Opcional):</strong></td>
                        <td align="left">
                            <%
           inputText = new HTML();
           out.println( "" + inputText.getinputText( "noCuenta", 20,20 ) );
                            %><br/>
                        </td> 
