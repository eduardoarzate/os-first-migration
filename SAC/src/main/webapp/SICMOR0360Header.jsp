...
<%
   ...
   cbTipoTrxsValues = myComboBox.getTipoTrxs(session,"1,20,21");
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICMOR0360Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
