<%
/*###############################################################################
# Nombre del Programa :  SICLIR0040HHeader.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletIntegH?action=SICMIR0040HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR0040H - Reporte Integral&nbsp; de Transacciones por comercio</font></th>
                    </tr>
