<%
/*###############################################################################
# Nombre del Programa :  SICLIR0460Header.jsp                                   #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletLiqH?action=SICLIR0460HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0460 - Reporte de Transacciones Extempor&aacute;neas por Emisor</font> 
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            %>
                            <br/>
                            <span id = "txtBancoEmi" class="ocultar">Elija una Opción</span>
                        </td>
                        <td><br></td> 
                        <td><br></td> 
                    </tr>
