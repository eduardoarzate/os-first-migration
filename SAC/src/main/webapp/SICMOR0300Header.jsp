...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMonitoreo?action=SICMOR0300Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMOR0300 - Reporte de Transacciones Aceptadas por Emisor</font>  
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input name="txtfStartDate" type="text" id="txtfStartDate" size="15" readonly maxlength="15" onblur="javascript:sendData('bancoEmi', 'archivoEmi', 'comboBoxArchivo');" value=<%=session.getAttribute("fechaHoy")%>>
                        ...
                        <td align="left">
                            <% 
                                    comboBox = new HTML();
                            out.println( "" + comboBox.getComboBox( "bancoEmi", cbEmisor, "onchange", "javascript:sendData('bancoEmi','archivoEmi','comboBoxArchivo');","Seleciona Un Banco" ) );
                            %>
                            <br/>
                    ...
                    <tr>
                        ...
                        <td align="left" id = "comboBoxArchivo">
                            <select multiple="multiple">
                                <option>Selecciona un Bin</option>
                            </select>
                        </td>
                        ...
                        <td align="left">
                            <%
comboBox = new HTML();
out.println( "" + comboBox.getListBox( "bancoAdq", cbAdquirente,"Seleciona Un Banco" ) );
                            %><br/>
