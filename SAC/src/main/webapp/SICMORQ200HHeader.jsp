...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletPromoH?action=SICMORQ200HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMORQ200 - Reporte de Transacciones sin Promoci&oacute;n</font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "bancoSocio", cbBancosSocios, "Selecciona un Banco" ) );
                            %><br/>
