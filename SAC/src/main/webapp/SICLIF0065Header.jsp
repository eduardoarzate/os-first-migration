<%
/*###############################################################################
# Nombre del Programa :  SICLIF0065Header.jsp                                   #
...
<%
   ...
   cbBancoAdqInterRedValues  = myComboBox.getBancoIntEntPadre(session);   
%>
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIF0065Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left"><font color="#000000">SICLIF0065 - Consulta de Saldos por Grupo<br></font></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <% comboBox = new HTML();
       out.println( "" + comboBox.getListBox( "banco", cbBancoAdqInterRedValues, "Selecciona un Banco" ) );
                            %><br/>
                            <span id = "txtBanco" class="ocultar">Elije una Opciónn</span>
                        </td>
                        <td><br/></td>
                        <td><br/></td>
                    </tr>
