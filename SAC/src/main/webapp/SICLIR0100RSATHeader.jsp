...
<html>
    ...
    <body>
        <div align="center">
            <form action="ControllerServlet?action=SICLIR0100RSATMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
                <table width="100%" border="0" cellspacing="0" id="tabla">
                <tr>
                   <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0100RSAT - Reporte de Resumen SAT</font></th>
                </tr>
