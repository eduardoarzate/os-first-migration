<%
/*###############################################################################
# Nombre del Programa :  SICLIR0310Header.jsp                                   #
...
<%
    ...
    /* Modificacion: Marca de fin    SAS-DRT F-52-8063-16  */  
        cbIntValues = myComboBox.getBancoAdqEmiSinEglo(session);
        ArrayList cbIntValuesArch=myComboBox.getBancosEglo(session);
        cbMoneda = myComboBox.getClvmoneda(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        var showTextArchivoBanco = false;
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showTextBanco)
                {
                    ...
                    span.style.display = 'none';
                    showTextBanco = false;
                } else if (showTextArchivoBanco)
                {
                    span = document.getElementById('txtArchivoBanco');
                    span.style.display = 'none';
                    showTextArchivoBanco = false;
                }
                ...
                } else if (document.frmTOCHeader.banco.value == "None")
                {
                    ...
                    showTextBanco = true;
                    return false;
                } else if (document.frmTOCHeader.archivoBanco.value == "None")
                {
                    span = document.getElementById('txtArchivoBanco');
                    span.style.display = 'inline';
                    showTextBanco = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMonitoreo?action=SICLIR0310Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id= "tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0310 - Transacciones Rechazadas de Sintaxis por Bancomer / Banamex / E-Global<br></font></th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="4"><br/></td>
           ...
           out.println( "" + comboBox.getListBox( "banco", cbIntValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left"><strong>Archivo del Banco:</strong></td>
                        <td align="left">
                            <%
           comboBox = new HTML();
           out.println( "" + comboBox.getListBox( "archivoBanco", cbIntValuesArch, "Selecciona un Banco" ) );
                            %><br/>
                            <span id = "txtArchivoBanco" class="ocultar">Elije una Opción</span>
                        </td>  					  					
                    </tr>  								
                    <tr>
                        <td>&nbsp;</td>
