...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletProm?action=SICPRO003Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICPRO003 - Reporte </font><font color="#000000">Consolidado con</font><font color="#000000"> Promoci&oacute;n</font></th>
                    </tr>
