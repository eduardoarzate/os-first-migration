<%
/*###############################################################################
# Nombre del Programa :  SICLIRH0110Header.jsp                                  #
# Autor               :  Jesus Parra Martinez                                   #
# Compania            :  SAS S.A. DE C.V.                                       #
# Proyecto/Procliente :  P-06-0527-11                 	   FECHA:01/07/2015     #
# Descripcion General :	 Implementación de Hub de Pagos en PROSA		        #
#                                                                               #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletHub?action=SICLIRH0110Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIRH0110 - Liquidaci&oacute;n HUB de Pagos Bancos Socios</font></th>
                    </tr>
