<%
/*###############################################################################
# Nombre del Programa :  SICMIR1145Header.jsp                                   #
...
<%
    ...
    cbBancoAdqValues = myComboBox.getBancoAdqMultimoneda(session);
    cbMovimiento = myComboBox.getMovimiento(session);
%>
...
<html>
    ...
    <script type="text/javascript">
        ...
        function valida()
        {
            try
            {
                ...
                } else if (showMovimiento)
                {
                    span = document.getElementById('txtmovimiento');
                    span.style.display = 'none';
                ...
                } else if (document.frmTOCHeader.bancoAdq.value == "None")
                {
                    ...
                    return false;
                } else if (document.frmTOCHeader.movimiento.value == "None")
                {
                    span = document.getElementById('txtmovimiento');
                    span.style.display = 'inline';
                    showMovimiento = true;
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletMasVi?action=SICMIR1145Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIR1145 - Outgoing Internacional Visa</font></th>
                    </tr>
            ...
            out.println( "" + comboBox.getListBox( "bancoAdq", cbBancoAdqValues, "Selecciona un Banco" ) );
                        ...
                        <td align="left">
                            <%
            comboBox = new HTML();
            out.println( "" + comboBox.getComboBox( "movimiento", cbMovimiento, "Selecciona el Movimiento" ) );
                            %><br/>
                            <span id = "txtmovimiento" class="ocultar">Elije una Opción</span>
                        </td>
                    </tr>
