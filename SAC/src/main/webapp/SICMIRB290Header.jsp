...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletAdquirente?action=SICMIRB290Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICMIRB290 - Reporte Integral de Transacciones Recibidas por PROSA    
                            </font></th>
                    </tr>
