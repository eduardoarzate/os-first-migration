<%
/*###############################################################################
# Nombre del Programa :  SICPRO003HHeader.jsp                                   #
# Autor               :  GUSTAVO ALBERTO RAMIREZ FRANCO                         #
# Compania            :  Promocion y Operacion, S.A.                            #
# Proyecto/Procliente :                                	   FECHA:15/10/2013     #
# Descripcion General :																					                #
#                                                                               #
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletPromoH?action=SICPRO003HMain" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICPRO003H - Reporte Historico</font><font color="#000000">Consolidado con</font><font color="#000000"> Promoci&oacute;n</font></th>
                    </tr>
