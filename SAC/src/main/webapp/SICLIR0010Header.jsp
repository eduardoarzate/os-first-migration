...
/*
################################################################################
# Nombre del Programa : SICLIR0010Header.jsp                                   #
...
# Cond. de ejecucion  : A peticion de usuario por medio de application server  #
# Dias de ejecucion   : Diario                             Horario: 00:00      #
################################################################################
#                               MODIFICACIONES                                 #
#------------------------------------------------------------------------------#
...
<%
 ...
 /* Modificacion: Marca de inicio    SAS-DRT F-52-8063-16  */
    ...
    ArrayList cbTipoLiq= myComboBox.getTipoLiq10(session);
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletCompensacion?action=SICLIR0010Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0010 - Reporte de Compensaciones Complementarias</font></th>
                    </tr>
