<%
/*###############################################################################
# Nombre del Programa :  SICLIR0580Header.jsp                                   #
# Autor               :  JOSE ANDRES CASTILLO MORENO                            #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  P-08-299-04                 	   FECHA:27/08/2010     #
# Descripcion General :										                    #
#                                                                               #
...
<%
    if(!ga.AccessGranted(session, "grantAccess")){
        ...
        session.setAttribute("report", "580");
...
<html>
    ...
    <body>
        <div align="center">
            ...
            <form action="ControllerServletInterf?action=SICLIR0580Main" method="post" name="frmTOCHeader" target="mainFrameTOC" id="frmTOCHeader">
            <!--Marca de cambio:  SAS-DRT F-52-8063-16  fin Modificación -->
                <table width="100%" border="0" cellspacing="0" id="tabla">
                    <tr>
                        <th id="tituloTab" width="100%" colspan="5" align="left" ><font color="#000000">SICLIR0580 - Reporte de Liquidaciones Complementarias<br></font></th>
                    </tr>
