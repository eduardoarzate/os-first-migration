/*###############################################################################
# Nombre del Programa :  ConexionORACLEH.java                                    #
...
import com.wellcom.conexion.ConexionORACLE.cerrarConexion;
import com.wellcom.conexion.ConexionORACLE.cerrarConexion.Actividad;
import com.wellcom.exceptions.*;

public class ConexionORACLEH {
    ...
    public ConexionORACLEH(String jndi) {
        //this.resultSet = null;
        this.rsMetaData = null;
        this.rsColumnsTitles = null;
        this.rsColumnsData = null;
    ...
    public ConexionORACLEH(String url, String baseDeDatos, String usuarioMySQL, String contrasena) {
        this.url = url;
