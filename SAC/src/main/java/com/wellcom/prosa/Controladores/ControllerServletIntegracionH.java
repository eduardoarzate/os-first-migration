/*###############################################################################
# Nombre del Programa :  ControllerServletIntegracionH.java                     #
...
/**
 * Servlet implementation class ControllerServletIntegracionH
 */
public class ControllerServletIntegracionH extends HttpServlet {
     ...
     */
    public ControllerServletIntegracionH() {
        super();
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (this.session != null && this.session.getAttribute("activo") != null) {
            ...
            System.out.println("ControllerServletIntegracionH session: " + this.sessionId);
        ...
        try {
            if (action != null) {
                if (action.equals("login")) {
                    //session.invalidate();
                    System.out.println("Action Login ControllerServletIntegracionH: " + action);
                    url = "/login.jsp";
                }//Comienzan reportes 
