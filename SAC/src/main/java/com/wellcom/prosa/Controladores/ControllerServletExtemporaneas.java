/*###############################################################################
# Nombre del Programa :  ControllerServletExtemporaneas.java                    #
...
/**
 * Servlet implementation class ControllerServletExtemporaneas
 */
public class ControllerServletExtemporaneas extends HttpServlet {
     ...
     */
    public ControllerServletExtemporaneas() {
        super();
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (this.session != null && this.session.getAttribute("activo") != null) {
            ...
            System.out.println("ControllerServletExtemporaneas session: " + this.sessionId);
        ...
        try {
            if (action != null) {
                if (action.equals("login")) {
                    //session.invalidate();
                    System.out.println("Action Login ControllerServletExtemporaneas: " + action);
                    url = "/login.jsp";
                } //Comienzan reportes 
