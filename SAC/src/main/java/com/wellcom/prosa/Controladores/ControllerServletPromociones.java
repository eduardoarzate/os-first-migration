/*###############################################################################
# Nombre del Programa :  ControllerServletPromociones.java                      #
...
/**
 * Servlet implementation class ControllerServletPromociones
 */
public class ControllerServletPromociones extends HttpServlet {
     ...
     */
    public ControllerServletPromociones() {
        super();
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (this.session != null && this.session.getAttribute("activo") != null) {
            ...
            System.out.println("ControllerServletPromociones session: " + this.sessionId);
        ...
        try {
            if (action != null) {
                if (action.equals("login")) {
                    //session.invalidate();
                    System.out.println("Action Login ControllerServletPromociones: " + action);
                    url = "/login.jsp";
                } //Comienzan reportes 
